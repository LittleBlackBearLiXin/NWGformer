...
from lg_parse import parser_add_main_args
from logger import *
from dataset import load_dataset
from data_utils import eval_acc
from layers import NWGformerT,oursgat
from eval import *
...
class MPNNs(torch.nn.Module):
    def __init__(self, in_channels, hidden_channels, out_channels, local_layers=3,
        ...
        self.former1=NWGformerT(in_channels,hidden_channels)
        self.former2 = NWGformerT(hidden_channels, hidden_channels)
        if self.pre_ln:
...
S = save_or_load_shortest_paths(dataset.graph['edge_index'], n,k=10,filename='arxiv.pkl')
